...
m = Map("network", translate("Switch"), translate("The network ports on this device can be combined to several <abbr title=\"Virtual Local Area Network\">VLAN</abbr>s in which computers can communicate directly with each other. <br><abbr title=\"Virtual Local Area Network\">VLAN</abbr>s are often used to separate different network segments. Often there is by default one Uplink port for a connection to the next greater <br> network like the internet and other ports for a local network.<br><br>"))
...
m.uci:foreach("network", "switch",
	function(x)
		...
		s = m:section(NamedSection, x['.name'], "switch",
			switch_title and translatef("<br>Switch %q (%s)", switch_name, switch_title)
					      or translatef("<br>Switch %q", switch_name))
...
s.template = "admin_network/switch_status_sc"
s.switches = switches
