...
if luci.http.formvalue("display") ~= "list" then
	f = m:section(SimpleSection, nil, translate("Configuration<br><br>This is a list of shell glob patterns for matching files and directories to include during sysupgrade. Modified files in /etc/config/ and certain other configurations are automatically preserved."))
	...
	f = m:section(SimpleSection, nil, translate("Configuration<br><br>Below is the determined list of files to backup. It consists of changed configuration files marked by opkg, essential base files and the user defined backup patterns."))
