...
mount.extedit  = luci.dispatcher.build_url("admin/filesystems/mount_points/mount/%s")
...
swap.extedit  = luci.dispatcher.build_url("admin/filesystems/mount_points/swap/%s")
